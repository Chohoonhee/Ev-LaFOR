...
class Caltech101DataEventOursUnpairProto(Dataset):
    ...
    def __getitem__(self, index):
        ...
        return events, label, index, image, event_stack, image_path
