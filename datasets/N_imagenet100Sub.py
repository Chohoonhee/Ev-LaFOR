...
class N_Imagenet100Sub(Dataset):
    def __init__(self, prompts, code, preprocess=None, image_dir = '/ssd2/EV-CLIP-V2/data/ImageNet', event_dir = '/ssd2/EV-CLIP-V2/data/N_ImageNet',
        ...
        self.data = []
        train = open("/ssd2/EV-CLIP-V2/data/N_ImageNet/train_100_list.txt", "r")
        test = open("/ssd2/EV-CLIP-V2/data/N_ImageNet/val_100_list.txt", "r")
