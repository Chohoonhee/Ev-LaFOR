...
class N_Imagenet100_zero(Dataset):
    def __init__(self, prompts, code, preprocess=None, color=False, sub=False, image_dir = '/mnt4/data/ImageNet', event_dir = '/mnt4/data/N_ImageNet',
        ...
        if self.split == 'train':
            if sub:
                self.data = np.array(self.data)[sorted(np.random.choice(len(self.data), 1000, replace=False))]
