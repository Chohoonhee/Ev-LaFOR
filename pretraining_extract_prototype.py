...
from datasets import Caltech101DataEvent, N_Imagenet, Caltech101DataEventOursUnpairProto, Caltech101DataEventOursPair, CifarEventUnpair, N_Imagenet_Tiny, N_Imagenet100, N_Imagenet_Mini_Proto
...
def train(args, io):
    ...
    elif args.dataset == 'imagenet_mini':
        code = ['n01748264', 'n01774384', 'n01819313', 'n01592084', 'n01644373', 'n01530575', 'n01820546', 'n01629819', 'n01756291', 'n01776313', 'n01494475', 'n01728572', 'n01616318', 'n01514859', 'n01734418', 'n01518878', 'n01440764', 'n01664065', 'n01773157', 'n01580077', 'n01729322', 'n01770393', 'n01632777', 'n01608432', 'n01534433', 'n01828970', 'n01797886', 'n01631663', 'n01749939', 'n01784675', 'n01704323', 'n01695060', 'n01735189', 'n01751748', 'n01693334', 'n01843065', 'n01737021', 'n01675722', 'n01560419', 'n01484850', 'n01688243', 'n01729977', 'n01537544', 'n01697457', 'n01685808', 'n01694178', 'n01632458', 'n01742172', 'n01728920', 'n01817953', 'n01824575', 'n01667114', 'n01829413', 'n01496331', 'n01855032', 'n01641577', 'n01682714', 'n01698640', 'n01806567', 'n01630670', 'n01843383', 'n01692333', 'n01614925', 'n01773797', 'n01667778', 'n01855672', 'n01558993', 'n01622779', 'n01798484', 'n01807496', 'n01531178', 'n01669191', 'n01498041', 'n01491361', 'n01677366', 'n01443537', 'n01770081', 'n01796340', 'n01739381', 'n01818515', 'n01795545', 'n01601694', 'n01775062', 'n01768244', 'n01582220', 'n01744401', 'n01755581', 'n01689811', 'n01847000', 'n01833805', 'n01532829', 'n01806143', 'n01514668', 'n01774750', 'n01644900', 'n01687978', 'n01773549', 'n01665541', 'n01740131', 'n01753488']
        test_prompts = ['Indian cobra', 'southern black widow', 'sulphur-crested cockatoo', 'chickadee', 'tree frog', 'brambling', 'lorikeet', 'fire salamander', 'sidewinder rattlesnake', 'tick', 'hammerhead shark', 'worm snake', 'vulture', 'hen', 'kingsnake', 'ostrich', 'tench', 'loggerhead sea turtle', 'yellow garden spider', 'jay', 'eastern hog-nosed snake', 'scorpion', 'axolotl', 'kite (bird of prey)', 'junco', 'bee eater', 'ruffed grouse', 'newt', 'green mamba', 'centipede', 'triceratops', 'Komodo dragon', 'garter snake', 'sea snake', 'European green lizard', 'jacamar', 'water snake', 'banded gecko', 'bulbul', 'great white shark', 'frilled-necked lizard', 'smooth green snake', 'indigo bunting', 'Nile crocodile', 'desert grassland whiptail lizard', 'chameleon', 'spotted salamander', 'boa constrictor', 'ring-necked snake', 'african grey parrot', 'coucal', 'mud turtle', 'hornbill', 'electric ray', 'red-breasted merganser', 'American bullfrog', 'Carolina anole', 'American alligator', 'quail', 'smooth newt', 'toucan', 'Gila monster', 'bald eagle', 'European garden spider', 'terrapin', 'goose', 'American robin', 'great grey owl', 'prairie grouse', 'partridge', 'goldfinch', 'box turtle', 'stingray', 'tiger shark', 'green iguana', 'goldfish', 'harvestman', 'ptarmigan', 'vine snake', 'macaw', 'black grouse', 'American dipper', 'wolf spider', 'trilobite', 'magpie', 'African rock python', 'eastern diamondback rattlesnake', 'alligator lizard', 'duck', 'hummingbird', 'house finch', 'peafowl', 'rooster', 'tarantula', 'tailed frog', 'agama', 'barn spider', 'leatherback sea turtle', 'night snake', 'Saharan horned viper']
...
#   
    ...
    if args.dataset == 'caltech':
        ...
        # voxel_dim=(9,180,240)
        train_dataset = Caltech101DataEventOursUnpairProto(split='train', train_type = 'zero', pair= args.pair, test_type = 'full', clsw = args.cls, preprocess=preprocess)
        test_dataset = Caltech101DataEventOursUnpairProto(split='test', preprocess=preprocess)
        voxel_dim=(9,180,240)
        ...
        train_dataset = N_Imagenet100(split='train', prompts = test_prompts, code = code, preprocess=preprocess, color = args.color, sub=args.sub)
        test_dataset = N_Imagenet100(split='test', prompts = test_prompts, code = code, preprocess=preprocess, color=args.color, sub=args.sub)
        voxel_dim=(9,480, 640)
    elif args.dataset in ['imagenet_mini']:
        train_dataset = N_Imagenet_Mini_Proto(split='train', prompts = test_prompts, code = code, preprocess=preprocess)
        test_dataset = N_Imagenet_Mini_Proto(split='test', prompts = test_prompts, code = code, preprocess=preprocess)
        voxel_dim=(9,480, 640)
    elif args.dataset == 'cifar10':
        ...
        voxel_dim=(9, 128, 128)
    train_dataset[0]
    train_dataloader = Loader(train_dataset, args, device, 'train', proto_type=True)
    test_loader = Loader(test_dataset, args, device, 'test', proto_type=True)
    ...
    total = 0
    with torch.no_grad():
        for (event, label, _, image, _, im_path) in tqdm(train_dataloader):
            optimizer.zero_grad()
            ...
            prototype[label.item()].append((feature / feature.norm(dim=-1, keepdim=True)).detach().cpu().numpy())
    ...
    for i in prototype.keys():
        if len(prototype[i]) > 0:
            result_proto[i] = np.mean(np.concatenate(prototype[i], axis=0), axis=0) 
    # for i in prototype.keys():
    #     if len(prototype[i]) > 0:
    ...
    # np.save("proto_imagenet100_hs_norm_3channel.npy", result_proto)

    np.save("proto_caltech_unpair_full.npy", result_proto)
    # np.save("proto_imagenet_mini_unpair.npy", result_proto)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--exp_name', '-en', type=str, default='test', metavar='N',
    ...
    parser.add_argument('--dataset', '-d', type=str, default='caltech', help='dataset name')
